...
public class QuadraticRegressionAgent extends Agent {
        ...
        addBehaviour(new ContractNetResponder(this, template) {
            ...
            protected ACLMessage handleCfp(ACLMessage cfp) {
                try {
                    ...
                    double[] coef = RegressionUtils.polynomialRegression(data, 2);
                    double r2 = RegressionUtils.rSquared(data, coef);
                    result = new RegressionResult("quadratic", coef, r2);
